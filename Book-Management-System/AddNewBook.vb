...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label7.Text = "Add/Edit New Book"
...
#End Region
    ...
    Private Sub frmAddNewBook_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cn = New SqlConnection("Server=reception;uid=sa;pwd=aptech;database=master")
        cn.Open()
    ...
    Sub AutoID()
        ...
        'For i = 0 To ds1.Tables("tblbookdetails1").Rows.Count - 1
        '    If Id = ds1.Tables("tblbookdetails1").Rows(i).Item(0) Then
        '        i = ds1.Tables("tblbookdetails1").Rows.Count - 1
        '        Id = i + 5
        '        Me.txtBookid.Text = Id
        '        Exit Sub
        '    End If
        'Next
